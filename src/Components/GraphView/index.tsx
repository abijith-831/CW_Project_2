      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 2xl:grid-cols-3  gap-x-12 gap-y-4">
        ...
        {!loading &&
          companyData?.map((company, index) => (
            <div onClick={()=> onCompanyClick(company)} key={index} className="w-[350px]  sm:w-[350px] md:w-[350px] lg:w-[400px] xl:w-[500px] cursor-pointer mx-auto hover:bg-gray-100 dark:bg-neutral-700 hover:dark:bg-neutral-600 dark:border-[#4b5563] rounded-lg duration-300 overflow-hidden transition-transform">
