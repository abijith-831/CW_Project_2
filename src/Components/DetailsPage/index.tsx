  ...
  return ( 
    <div className="flex flex-col min-h-screen">
        ...
        <div className="w-full relative py-2 cursor-pointer ">
            <button className="absolute left-4  cursor-pointer rounded-full px-1.5 py-1.5 md:px-2.5 md:py-2.5  md:left-10 lg:left-20 top-4   text-primary font-medium hover:bg-gray-200 dark:hover:bg-gray-500 border border-third" onClick={goToDashboard}>
